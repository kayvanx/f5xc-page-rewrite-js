...
(() => {
    ...
    if (urlSearchTerm && urlReplacementText !== null) {
        ...
        //console.log("k1-testing: URL parameters not provided or incomplete. Using internal defaults to upgrade links to HTTPS.");
    ...
    if (match) {
        try {
            ...
            //console.error(`k1-testing: Invalid regex? : "${searchTerm}"`, e);
            return;
        }
    } else {
