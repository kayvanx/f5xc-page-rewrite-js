/**
 * v1.1 - Oct 2025 - By: Kayvan Farzaneh (kayvan@f5.com)
 * 
...
(() => {
    ...
    if (urlSearchTerm && urlReplacementText !== null) {
        ...
        if (match) {
            try {
                ...
                //console.error(`k1-testing: patternRewrite.js: Invalid Regex: "${urlSearchTerm}"`, e);
                return;
            }
        } else {
    ...
    if (!searchPattern || replacementText === null) {
        //console.error("k1-testing: Could not establish a valid search pattern and replacement!!");
        return;
    }
